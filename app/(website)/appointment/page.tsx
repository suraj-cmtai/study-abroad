...
import { CalendarIcon, Send, Clock, Calendar as CalendarIcon2, MapPin, ArrowRight, X } from "lucide-react";
import { cn } from "@/lib/utils";
import { toast } from "sonner";

// Environment variables for Calendly API
const CALENDLY_USER = process.env.CALENDLY_USER || "studyabroadbyvalueadz8";
const CALENDLY_API_URL = "https://api.calendly.com";
const CALENDLY_CLIENT_ID = process.env.CALENDLY_CLIENT_ID;
const CALENDLY_SECRET_KEY = process.env.CALENDLY_SECRET_KEY;
